...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var jqFilter = $('input[type="search"]', filter)
			...
			.bind( 'http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/keyup.DT search.DT input.DT paste.DT cut.DT', function(e) {
			...
			.bind( 'http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/keypress.DT', function(e) {
		...
		$(settings.nTable).on( 'http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/filter.DT', function () {
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		select
			...
			.bind( 'http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/change.DT', function(e) {
	...
	{
		$(n)
			.bind( 'http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/click.DT', oData, function (e) {
					n.blur(); // Remove focus outline for mouse users
					fn(e);
				} )
			.bind( 'http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/keypress.DT', oData, function (e){
				if ( e.which === 13 ) {
					fn(e);
				} } )
			.bind( 'http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/selectstart.DT', function () {
	...
	DataTable.defaults = {
		 ...
		 *   $('#example').dataTable( {
		 *     "ajax": "http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/data.json"
		 *   } );
		 *
		 * @example
		 ...
		 *   $('#example').dataTable( {
		 *     "ajax": {
		 *       "url": "http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/data.json",
		 *       "dataSrc": "tableData"
		 *     }
		 *   } );
		 *
		 ...
		 *           json[i][0] = '<a href="http://dev9.bmedia.ru/message/%27+json[i][0]+%27>View message</a>%27; *         } *         return json; *       } *     } *   } ); * * @example *   // Add data to the request *   $(%27#example%27).dataTable( { *"ajax": {
		 *       "url": "http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/data.json",
		 *       "data": function ( d ) {
		 *         return {
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "ajax": "http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/sources/arrays.txt",
		 *        "deferRender": true
		 *      } );
		 *    } );
		 */
		 ...
		 *      $('#example').dataTable( {
		 *        "serverSide": true,
		 *        "ajax": "http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/xhr.php"
		 *      } );
		 *    } );
		 */
		"bServerSide": false,
		 ...
		 *      $('#example').dataTable( {
		 *        "serverSide": true,
		 *        "ajax": "http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/scripts/server_processing.php",
		 *        "deferLoading": 57
		 *      } );
		 *    } );
		 *
	...
	DataTable.defaults.column = {
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "ajaxSource": "http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/sources/objects.txt",
		 *        "columns": [
		 *          { "data": "engine" },
		 *          { "data": "browser" },
		 *          { "data": "platform" },
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "ajaxSource": "http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/sources/deep.txt",
		 *        "columns": [
		 *          { "data": "engine" },
		 *          { "data": "browser" },
		 *          { "data": "platform.inner" },
	...
	$.extend( true, DataTable.ext.renderer, {
		header: {
			_: function ( settings, cell, column, idx, classes ) {
				...
				$(settings.nTable).on( 'http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/order.dt', function ( e, settings, sorting, columns ) {
					cell
						.removeClass(
	 ...
	 *     $('#table').dataTable().on('http://dev9.bmedia.ru/toolkit/inspinia_admin_theme/js/plugins/dataTables/xhr.dt', function (e, settings, json) {
