...
<div class="ready_todo col-lg-10" id="ready_todo">
	...
	<div class="pull-left tooltip-demo">
		<a href="mail_compose.html" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Reply"><i class="fa fa-reply"></i> Ответить</a>
		<a class="btn btn-sm btn-white replay_b" href="#replay"><i class="fa fa-arrow-right"></i> Переслать</a>
		<a href="#" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Print email"><i class="fa fa-print"></i> </a>
		<a href="#" class="btn btn-white btn-sm active-delet" data-rel="<?php echo $mail_dump["body"]->Id_mail_box;?>"><i class="fa fa-trash-o"></i> </a>
	</div>
	<h2>
		<br>
	</h2>
...
<?php endif?>
	<div class="mail-body text-right tooltip-demo">
			<a class="btn btn-sm btn-white" href="mail_compose.html"><i class="fa fa-reply"></i> Ответить</a>
			<a class="btn btn-sm btn-white replay_b" href="#replay"><i class="fa fa-arrow-right"></i> Переслать</a>
			...
			<button title="" data-placement="top" class="btn btn-sm btn-white active-delet" data-rel="<?php echo $mail_dump["body"]->Id_mail_box;?>"><i class="fa fa-trash-o"></i> Удалить</button>
	</div>
	<div class="clearfix"></div>
</div>
<script type="text/javascript">
	$(document).ready(function(){
		socket.emit('open_email',{
 			user_id: <?php echo $this->session->userdata("ses_user_id")?>
		});
