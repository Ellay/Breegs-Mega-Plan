...
<body class="gray-bg">
	...
	<div class="middle-box text-center loginscreen  animated fadeInDown">
		<div>
			...
			<form class="m-t" role="form" action="/welcome/auth" method="POST">
				<div class="form-group">
					<input type="text" class="form-control" placeholder="Username" required="" name="user_login">
				</div>
				<div class="form-group">
	...
	<!-- Mainly scripts -->
	<script src="<?php echo $resources_url?>js/jquery-1.10.2.js"></script>
