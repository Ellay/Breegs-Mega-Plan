...
var user_id="<?php echo $this->session->userdata("ses_user_id")?>";
	$(document).ready(function(){
		...
		$("#mail_body_content").on("click", ".active-delet", function(){
			var mail_id=$(this).attr("data-rel");
			$.ajax({
				type: "POST",
				url: "/staff/delet_mail/"+mail_id,
				success: function(req){
					$( "tr.unread .mail-contact" ).first().click();
				}
			});
			return false;
		})
