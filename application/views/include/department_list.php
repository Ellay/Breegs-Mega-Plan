...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	?>
		...
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<h5><?php echo $row->department_title?></h5>
			...
			<div class="ibox-content">
				<table class="table">
					...
					<tbody>
					<?php foreach($user_list_by_dep[$row->Id_department] as $sub_row):?>
					<tr>
	...
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<h5>Форма добавления нового отдела <small>Поля помеченные звездочкой обязательны</small></h5>
				<div class="ibox-tools">
					<a class="collapse-link">
						<i class="fa fa-chevron-up"></i>
					</a>
			...
			<div class="ibox-content">
				<form method="POST" class="form-horizontal" action="/staff/departments_list/add_new">
					<div class="form-group">
						<label class="col-sm-2 control-label">Название отдела *</label>
						<div class="col-sm-10"><input type="text" class="form-control" name="department_title"></div>
					</div>
					<div class="hr-line-dashed"></div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">Описание *</label>
						<div class="col-sm-10"><input type="text" class="form-control" name="department_description"></div>
					</div>
					<div class="hr-line-dashed"></div>
